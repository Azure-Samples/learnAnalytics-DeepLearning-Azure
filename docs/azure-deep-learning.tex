...
\NormalTok{            x }\OperatorTok{=}\NormalTok{ vggblock(x, conv[cnt], model_layers, }\StringTok{'conv}\SpecialCharTok{%d}\StringTok{_}\SpecialCharTok{%d}\StringTok{'} \OperatorTok{%}\NormalTok{ (outer, }\DecValTok{1}\OperatorTok{+}\NormalTok{inner))}
...
\NormalTok{        download(}\StringTok{'https://cntk.ai/jup/}\SpecialCharTok{%s}\StringTok{'} \OperatorTok{%}\NormalTok{ local_path, local_path)}
...
\subsection{Optimizing the loss}\label{optimizing-the-loss}
...
\NormalTok{                         bounds}\OperatorTok{=}\NormalTok{bounds, options}\OperatorTok{=}\NormalTok{\{}\StringTok{'maxiter'}\NormalTok{: inner\}, jac}\OperatorTok{=}\VariableTok{True}\NormalTok{)}
        \BuiltInTok{print}\NormalTok{(}\StringTok{'objective : }\SpecialCharTok{%s}\StringTok{'} \OperatorTok{%}\NormalTok{ s.fun[}\DecValTok{0}\NormalTok{])}
\NormalTok{        x0 }\OperatorTok{=}\NormalTok{ vec2img(s.x)}
\NormalTok{        path }\OperatorTok{=} \StringTok{'output_}\SpecialCharTok{%d}\StringTok{.jpg'} \OperatorTok{%}\NormalTok{ i}
